  ...
  {!isAnimateSearch && (
    <motion.div initial={{ opacity: 0, y: -20 }}
      ...
      transition={{ duration: 0.3, ease: 'easeOut' }}
       className={`text-primary-800 font-outfit flex w-full max-md:flex-col max-md:space-y-1 md:items-center md:justify-between ${isAnimateSearch ? '' : 'lg:hidden'}`}
    >
...
<div   className="relative flex w-[80%] items-center text-center max-2xl:-translate-y-3 max-xl:w-4/5 max-xl:-translate-y-0 max-lg:w-full max-md:w-full mt-2">
      {/* Ícone Search */}
