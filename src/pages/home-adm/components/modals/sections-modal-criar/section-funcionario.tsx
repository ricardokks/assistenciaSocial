      ...
      <form action="POST" className="flex size-full flex-col items-start justify-between gap-4">
        ...
        <div className="flex h-4/5 w-full flex-col gap-4 overflow-y-scroll px-10 ">
          ...
          <div className="grid w-full grid-cols-2 gap-x-4 pr-4">
            ...
            {/* nome  */}
            <div className="flex w-[97%] flex-col gap-1">
              <p className="text-primary-800 font-outfit">Data de Nascimento do Funcionário:</p>
          ...
          {/* nome  */}
          <div className="flex w-[97%] flex-col gap-1">
            <p className="text-primary-800 font-outfit">Nome da Mãe do Funcionário:</p>

            <div className="relative flex w-full rounded-2xl">
              <input
                className="border-primary-800/50 text-primary-800 focus:border-primary-800  w-full rounded-2xl  border-2 p-2 pl-10 outline-none"
                placeholder="Digite o nome da Mãe do Funcionário"
                type="text"
              />
              <IconeCidadao className="absolute left-2 top-2 size-7" />
            </div>
          ...
          {/* Localidade  */}
          <div className="flex w-[97%] flex-col gap-1">
            <p className="text-primary-800 font-outfit">Localidade do Funcionário:</p>

            <div className="relative flex w-full rounded-2xl">
              <input
                className="border-primary-800/50 text-primary-800 focus:border-primary-800  w-full rounded-2xl  border-2 p-2 pl-10 outline-none"
                placeholder="Digite a localidade Funcionário"
                type="text"
              />
          ...
          <div className="flex w-[97%] flex-col gap-1">
            ...
            <div className="relative flex w-full rounded-2xl">
              <input
                className="border-primary-800/50 text-primary-800 focus:border-primary-800  w-full rounded-2xl  border-2 p-2 pl-10 outline-none"
                placeholder="Digite a rua do Funcionário"
                type="text"
              />
              <IconeLocal className="absolute left-2 top-2 size-7" />
            </div>
          ...
          <div className="grid w-full grid-cols-2 gap-x-4 pr-4">
            ...
            <div className="flex w-[97%] flex-col gap-1">
              ...
              <div className="relative flex w-full rounded-2xl">
                <input
                  className="border-primary-800/50 text-primary-800 focus:border-primary-800  w-full rounded-2xl  border-2 p-2 pl-10 outline-none"
                  placeholder="Digite o número da casa do Funcionário"
                  type="text"
                />
                <IconeCasa className="absolute left-2 top-2 size-7" />
              </div>
