      ...
      <form action="POST" className="flex w-full h-full flex-col items-start justify-between gap-4">
        ...
        <div className="flex px-10 w-full h-4/5 flex-col gap-4 overflow-y-scroll ">
          ...
          <div className="w-full grid grid-cols-2 gap-x-4 pr-4">
            ...
            <div className="flex w-[97%] flex-col gap-1">
              <p className="text-primary-800 font-outfit">Senha do Cidadão:</p>
            ...
            {/* nome  */}
            <div className="flex w-[97%] flex-col gap-1">
              <p className="text-primary-800 font-outfit">Data de Nascimento do Cidadão:</p>
          ...
          {/* nome  */}
          <div className="flex w-[97%] flex-col gap-1">
            <p className="text-primary-800 font-outfit">Nome da Mãe do Cidadão:</p>
          ...
          {/* Localidade  */}
          <div className="flex w-[97%] flex-col gap-1">
            <p className="text-primary-800 font-outfit">Localidade do Cidadão:</p>
