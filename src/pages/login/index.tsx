...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-between overflow-hidden bg-white">
        ...
        <form className='flex w-full flex-col items-center justify-center space-y-3'>
          <div className="flex h-[70%] w-full flex-col items-center justify-center">
            ...
            <div className="w-4/6 flex-col items-center rounded-2xl p-2">
             ...
             {/* CPF */}
            <div className="w-4/6 flex-col items-center rounded-2xl p-2">
              <label className="text-primary-800 placeholder:text-primary-50 font-outfit text-[16px] font-medium">CPF: </label>
              <div className='relative flex'>
          ...
          {/* botão de entrar */}
          <button className='bg-primary-800 px-4 py-1 w-1/2 rounded-2xl  text-white  mt-16 hover:bg-primary-100 hover:text-[#262626] duration-500 cursor-pointer text-lg font-satoshi-bold'> ENTRAR </button>
          {/* esqueci a senha */}
      ...
      <div className="relative h-full w-2/3" style={{ backgroundImage: `url(${imagemMassape})`, backgroundSize: "cover", }} />
    </div>
  )
}
