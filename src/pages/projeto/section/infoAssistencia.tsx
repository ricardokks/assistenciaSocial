        ...
        <section className="m-0 flex h-full max-h-[1000px] w-[100%] max-w-[1280px] flex-col items-center justify-center space-x-6 pt-10 max-md:mb-8 max-md:items-center max-md:justify-center max-md:gap-4 max-md:space-x-0 xl:min-h-[800px] ">
                ...
                <div className="m-0 flex h-full items-center justify-center space-x-6 pt-10 max-md:flex-col max-md:items-center max-md:justify-center max-md:gap-4 max-md:space-x-0 ">
                  <div className="rounded-4xl shadow-inner-[#194A99] shadow-inner-xl flex h-2/3 w-1/4 flex-col items-center justify-evenly bg-white p-4 drop-shadow-[#70A6FF] drop-shadow-xl max-md:w-full">
                    {<data.icone/>} 
                    <button className="botao-contato font-satoshi-black cursor-pointer rounded-2xl p-2 text-[1.1rem] max-md:w-full max-md:text-[14px]"> Entrar em contato</button>
                  </div>
                  ...
                  <div className="rounded-4xl shadow-inner-[#194A99] shadow-inner-xl flex h-2/3 max-h-[800px] w-3/4 flex-col overflow-hidden bg-white p-8 px-10 drop-shadow-[#70A6FF] drop-shadow-xl max-md:w-full max-md:px-0">
                    <div className="scrollbar-thin-personalizada flex h-full max-h-[calc(100%-0.1rem)] translate-x-5 flex-col pr-4 max-2xl:overflow-y-scroll">
                      ...
                      <div className="font-outfit mt-4 flex flex-col">
                        ...
                        <h2 className="text-primary-800 text-[16px] font-light">
                         {data.descrição}
                        </h2>
                      </div>
