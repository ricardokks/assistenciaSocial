export function MapaAssistencia(data: { localizacao: string }) {
  return (
    <section 
    className="fade-up-animate m-0 mt-4 flex h-full max-h-[1000px] w-[100%] max-w-[1280px] flex-col items-center space-x-6 max-md:gap-4 max-md:space-x-0 xl:min-h-[800px]">
