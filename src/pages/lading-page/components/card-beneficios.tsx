...
export function CardBeneficios(props: CardBeneficiosProps) {
  return (
    <div className="flex items-center justify-center" data-aos="fade-left">
      <article className="shadow-card-beneficio font-outfit flex w-auto flex-col items-center justify-center gap-6 rounded-[17.2px] p-5 transition-all duration-500 ease-in-out hover:scale-110">
