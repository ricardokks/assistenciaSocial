...
export function InicioBanner() {
  return (
    <div className="background-gradient-banner relative mt-2 flex h-[28%] w-[95%] items-center justify-between rounded-2xl px-8 max-md:h-[35%] max-md:max-h-[380px] max-md:flex-col max-md:px-4 max-md:pt-4 md:py-14 ">
      <div className="flex w-[55%] flex-col text-white max-md:w-full">
        ...
        <h1 className="font-satoshi-black text-[26px] max-md:text-[16px] md:mt-0.5">
