...
export function Banner() {
    return (
        <div className="w-[90%] background-gradient-banner h-1/4 md:py-10 rounded-2xl mt-4 flex justify-between px-8 relative max-md:flex-col max-md:h-[35%] max-md:pt-4 max-md:px-4 max-md:max-h-[350px] ">
