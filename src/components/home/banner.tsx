...
export function InicioBanner() {
    return (
        <div className="w-[95%] background-gradient-banner h-[28%] md:py-14 rounded-2xl mt-2 flex justify-between items-center px-8 relative max-md:flex-col max-md:h-[35%] max-md:pt-4 max-md:px-4 max-md:max-h-[380px] ">
