...
export function CardInicioAgendamento(props: InicioDadosProps) {
  return (
    <div className="flex size-full flex-col rounded-2xl border-2 border-[#194A99] pb-7 pt-3">
      ...
      <div className="flex h-1/2 w-full items-center px-3 pt-2">
        ...
        <h1 className="font-satoshi pl-2 text-3xl font-bold text-[#2D2D2D]">
          {props.valorAgendamento}
        </h1>
      </div>
