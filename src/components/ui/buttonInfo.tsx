  ...
  return (
    <>
      {data.status === 'PENDENTE' && (
        <button
          className={`font-outfit flex cursor-pointer items-center justify-center rounded-lg bg-[#FF5353] px-3 py-0.5 text-[13px]  text-white shadow-md duration-500 absolute bottom-2 left-2 max-md:w-full hover:shadow-lg max-md:py-1 max-md:text-sm`}
      ...
      {data.status === 'CONCLUIDO' && (
        <button
          className={`font-outfit bg-primary-800 flex cursor-pointer items-center justify-center rounded-lg px-3 py-0.5 text-[13px]  text-white shadow-md absolute bottom-2 left-2 max-md:w-full duration-500 hover:shadow-lg`}
      ...
      {data.status === 'RECUSADO' && (
        <button
          className={`font-outfit flex cursor-pointer  items-center justify-center rounded-lg bg-gray-600 px-3 py-0.5 text-[13px]  text-white shadow-md duration-500 absolute bottom-2 left-2 w-full hover:shadow-lg`}
